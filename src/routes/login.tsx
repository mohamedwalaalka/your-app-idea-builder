...
function Login() {
  ...
  return (
    <MobileShell withHero className="pb-10 pt-6">
      ...
      <button
        type="button"
        className="glass-card flex h-13 w-full items-center justify-center gap-3 rounded-2xl py-3.5 text-sm font-semibold text-foreground transition-colors hover:bg-accent"
      >
        <GoogleIcon />
